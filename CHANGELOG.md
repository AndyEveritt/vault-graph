...
**Every release gets a GitHub Release with the plugin's three files attached** (`main.js`,
`manifest.json`, `styles.css`; from 2.0.0 the exporter's zip is no longer attached) — see
